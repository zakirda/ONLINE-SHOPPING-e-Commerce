...
public partial class AddToCart3 : System.Web.UI.Page
{
         ...
         if (!IsPostBack)
         {
             ...
             if (Request.QueryString["id"] != null)
             {
                 if (Session["Buyitems"] == null)
                 {
                     ...
                     String myquery = "select * from Shoe where ProductId=" + Request.QueryString["id"];
                     ...
                     Response.Redirect("AddToCart3.aspx");
